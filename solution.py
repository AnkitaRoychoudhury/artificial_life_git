...
class SOLUTION:
    ...
    def Create_World(self):
        ...
        pyrosim.Send_Cube(name = "Torso", pos=[0,5,0.5] , size=[width, length, height])
        pyrosim.End()
    ...
    def Create_Body(self):
        ...
        pyrosim.Send_Cube(name = "Torso", pos=[0, 0, -4] , size=[width, 4, 0.5])
      ...
      #  pyrosim.Send_Joint( name = "Torso_LeftLeg" , parent= "Torso" , child = "LeftLeg" , type = "revolute", position = [-0.5,0,-4], jointAxis = '0 1 0') # -0.5,0,1
    ...
    def Create_Body2(self):
        ...
        pyrosim.Send_Cube(name = "Torso", pos=[0, -3, 1] , size=[width, 1, 0.5])
        pyrosim.Send_Joint( name = "Torso_BackLeg" , parent= "Torso" , child = "BackLeg" , type = "revolute", position = [0,-3.5,1], jointAxis = '1 0 0')
        pyrosim.Send_Cube(name = "BackLeg", pos=[0,-0.5,0] , size=[0.5, 1, 0.5])
        pyrosim.Send_Joint( name = "Torso_FrontLeg" , parent= "Torso" , child = "FrontLeg" , type = "revolute", position = [0,-3.5,1], jointAxis = '1 0 0')
        pyrosim.Send_Cube(name = "FrontLeg", pos=[0, 0.5, 0] , size=[0.5, 1, 0.5])

       # pyrosim.Send_Cube(name = "LeftLeg", pos=[-0.5, 0, 0] , size=[a, b, b])
       # pyrosim.Send_Joint( name = "Torso_LeftLeg" , parent= "Torso" , child = "LeftLeg" , type = "revolute", position = [-0.5,-3,1], jointAxis = '0 1 0')

      #  pyrosim.Send_Cube(name = "RightLeg", pos=[0.5, 0, 0] , size=[a, b, b])
      #  pyrosim.Send_Joint( name = "Torso_RightLeg" , parent= "Torso" , child = "RightLeg" , type = "revolute", position = [0.5,-3,1], jointAxis = '0 1 0')
